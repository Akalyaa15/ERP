<div class="tab-content">
    ...
    <div class="panel">
            ...
            <div class="form-group">
                        ...
                        <div class=" col-md-10">
                            <div class="pull-left mr15">
                                <img id="site-logo-preview" src="<?php echo get_file_uri(get_general_file_path("client", $model_info->id) . $model_info->client_logo); ?>" alt="..." />
                            </div>
                    ...
                    <div class="form-group">
        <label for="enable_client_logo" class="<?php echo $label_column; ?>"><?php echo lang('enable_client_logo'); ?>
        ...
        <div class="<?php echo $field_column; ?>">
            <?php
            echo form_checkbox("enable_client_logo", "1", $model_info->enable_client_logo ? true : false, "id='enable_client_logo'");
            ?>                       
        </div>
    </div>
    <?php } ?>
