<div class="panel">
    <div class="tab-title clearfix">
        ...
        <div class="title-button-group">
            ...
            echo modal_anchor(get_uri("partners/invitation_modal"), "<i class='fa fa-envelope-o'></i> " . lang('send_invitation'), array("class" => "btn btn-default", "title" => lang('send_invitation'), "data-post-partner_id" => $client_info->partner_id));
        }else{
  ...
  if($client_info->partner_id){
            echo modal_anchor(get_uri("partners/add_new_contact_modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_contact'), array("class" => "btn btn-default", "title" => lang('add_contact'), "data-post-client_id" => $client_id));
        }else{
