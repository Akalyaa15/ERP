<div class="tab-content">
    <?php echo form_open(get_uri("branches/save_payslip_info/"), array("id" => "job-info-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    ...
    <div class="panel">
          ...
          <div class="form-group">
                        ...
                        <div class=" col-md-10">
                            <div class="pull-left mr15">
                                <img id="site-logo-preview" src="<?php echo get_file_uri(get_general_file_path("branch", $branch_info->id) . $branch_info->payslip_logo); ?>" alt="..." />
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-md-10">
                            ...
                            echo form_input(array(
                                "id" => "payslip_prefix",
                                "name" => "payslip_prefix",
                                "value" => $branch_info->payslip_prefix,
                                "class" => "form-control",
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-md-10">
                            ...
                            echo form_input(array(
                                "id" => "payslip_color",
                                "name" => "payslip_color",
                                "value" => $branch_info->payslip_color,
                                "class" => "form-control",
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-md-10">
                            ...
                            echo form_textarea(array(
                                "id" => "payslip_footer",
                                "name" => "payslip_footer",
                                "value" => $branch_info->payslip_footer,
                                "class" => "form-control"
                            ));
                            ?>
                        </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            echo form_dropdown(
                                ...
                                "29" => "29",
                                "30" => "30",
                                "31" => "31",), $branch_info->payslip_generate_date, "class='select2 mini'"
                            );
                            ?>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            echo form_dropdown(
                                ...
                                "4" => "4","5" => "5","6" => "6","7" => "7","8" => "8","9" => "9","10" => "10","11" => "11","12" => "12","13" => "13","14" => "14","15" => "15","16" => "16","17" => "17","18" => "18","19" => "19","20" => "20","21" => "21","22" => "22","23" => "23","24" => "24",
                                    ), $branch_info->company_working_hours_for_one_day, "class='select2 mini'"
                            );
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <?php
                            echo form_dropdown(
                                    "maximum_no_of_casual_leave_per_month",$annual_leave_dropdown, $branch_info->maximum_no_of_casual_leave_per_month, "class='select2 mini'id='annual_leave'"
                            );
                            ?>
                        </div>
                        <div class="col-md-6">
        ...
        <div class=" col-md-10">
            ...
            ), "create_attendance", ($branch_info->payslip_created_status === "create_attendance") ? true : (($branch_info->payslip_created_status !== "create_timesheets") ? true : false));
            ?>
            ...
            echo form_radio(array(
                ...
                "name" => "payslip_created_status",
                "data-msg-required" => lang("field_required"),
                    ), "create_timesheets", ($branch_info->payslip_created_status === "create_timesheets") ? true : false);
            ?>
                   ...
                   <!--  <h5><?php echo lang("can_access_payslip"); ?> <span class="help" data-toggle="tooltip" title="Access permissions for team members."><i class="fa fa-question-circle"></i></span></h5> --> 
                    ...
                    <div>
                        ...
                        echo form_radio(array(
                            ...
                            "class" => "ot_permission toggle_specific",
                                ),$branch_info->ot_permission,  ($branch_info->ot_permission === "no") ? true : false);
                        ?>
                    ...
                    <div>
                        ...
                        echo form_radio(array(
                            ...
                            "value" => "all",
                            "class" => "ot_permission toggle_specific",
                                ), $branch_info->ot_permission, ($branch_info->ot_permission === "all") ? true : false);
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        echo form_radio(array(
                            ...
                            "value" => "specific",
                            "class" => "ot_permission toggle_specific",
                                ),$branch_info->ot_permission,  ($branch_info->ot_permission === "specific") ? true : false);
                        ?>
                        <label for="ot_permission_specific"><?php echo lang("enable_specific_members_or_teams") ?>:</label>
                        <div class="specific_dropdown">
                            <input type="text" value="<?php echo $branch_info->ot_permission_specific; ?>" name="ot_permission_specific" id="ot_specific_dropdown" class="w100p validate-hidden"  data-rule-required="true" data-msg-required="<?php echo lang('field_required'); ?>" placeholder="<?php echo lang('choose_members_and_or_teams'); ?>"  />
                        </div>
                    </div>
                    </a>
                </div>
        ...
        $("#job-info-form").appForm({
            ...
            onSuccess: function (result) {
                if (result.success) {
                    ...
                    setTimeout(function () {
                    window.location.href = "<?php echo get_uri("branches/view/" . $branch_info->id); ?>" + "/payslip_info";
                }, 500);
                } else {
...
<?php if($branch_info->maximum_no_of_casual_leave_per_month) {?>
<script type="text/javascript">
