...
foreach ($estimate_items as $item) {
    $client_countries = isset($item->receiver_client_country) ? $this->Countries_model->get_one($item->receiver_client_country) : null;
    $vendor_countries = isset($item->receiver_vendor_country) ? $this->Countries_model->get_one($item->receiver_vendor_country) : null;
