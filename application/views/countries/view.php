                ...
                <div class="box">
                    <div class="box-content w200 text-center profile-image">
                        ...
                        <span class="avatar avatar-lg">
                            <?php if ($country_info->image) { ?>
                                <img id="profile-image-preview" src="<?php echo get_file_uri(get_general_file_path("country_profile_image", $country_info->id) . $country_info->image) ?>" alt="...">
                            <?php } else { ?>
                                <img id="profile-image-preview" src="<?php echo get_avatar($country_info->image); ?>" alt="...">
                            <?php } ?>
                        </span> 
