...
<div class="form-group" id="country_app" >
    ...
    <div class="form-group" id="company_app" >
                        ...
                        <div class=" col-md-9">
                            ...
                            echo form_input(array(
                                ...
                                "class" => "form-control validate-hidden",
                                "placeholder" => lang('select_employer'),
                                "data-rule-required" => true,
                                "data-msg-required" => lang("field_required"),
                                 "readonly"=> true,
                            ));
    ...
    <div class="form-group" id="branch_app" >
                    ...
                    <div class="form-group" id="salary_app" >
                        <label for="branch" class=" col-md-3"><?php echo lang('salary'); ?></label>
                        <div class=" col-md-9">
                            <?php
...
<script type="text/javascript">
    $(document).ready(function () {
       ...
       $("#country").select2({
        ...
        $("#company").select2({
            multiple: false,
            data: <?php echo ($company_dropdown); ?>
        });
        ...
        $("#payslip_user_id").select2({
            ...
            ajax: {
                ...
                data: function (term, page,datepayslip) {
                    return {
                        q: term,payslip_date:$("#payslip_date").val(),saved_user_id:'<?php echo $model_info->user_id; ?>' // search term
                    };
                },
              ...
              //end specific  OT user check
                    ...
                    //end specific  OT user check
                            ...
                            // var branch =  response.item_info.user_branch;
                              var branch =  response.item_info.buid;
                              var company = response.item_info.company;
                            if(work_hours ==null){
                             ...
                             $("#submit_payslip").prop('disabled', true).prop('title','Please fill in  all the fields');
                            }else if(work_hours == null||work_hours ==""){
                             $("#submit_payslip").prop('disabled', true).prop('title','Please fill in  all the fields');
                            }else{
                                ...
                                // eligible cutt off 
     var annual_cuff = response.item_info.user_annual_leave;
        //Math.round(value,2)
        ...
        //end eligible cutofff
                             ...
                             $("#branch").select2("val",response.item_info.buid);
                             $("#company").select2("val",response.item_info.company);
                             $("#holiday_of_week").select2("val",[response.item_info.holiday_of_week]);

//get user salary
 $.ajax({ 
                    url: "<?php echo get_uri("payslip/get_user_salary_suggestion"); ?>",
                    data: {user_id:$("#payslip_user_id").val(),ot_permission:result_ot_permission},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
                    success: function (response) {
                        ...
                        //auto fill the description, unit type and rate fields.
                        if (response && response.success) {
                            $("#salary").val(response.item_info.salary);
                            }
                        }
                    });
                            ...
                            alert("This user not assign company");
...
<script type="text/javascript">
    ...
    $("#payslip_casual_leave").on("change", function() {
   
        var annual_cuff = $("#payslip_casual_leave").val();
        //Math.round(value,2)
        var year = 365/annual_cuff;
        var mon = 30/annual_cuff;
...
<?php if($model_info->payslip_casual_leave) {?>
<script type="text/javascript">
