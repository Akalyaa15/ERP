<div class="tab-content">
    <?php echo form_open(get_uri("companys/save/"), array("id" => "company-form", "class" => "general-form dashed-row white", "role" => "form")); ?>
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <?php if (isset($model_info)) { ?>
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="pull-left mr15">
                            <img id="site-logo-preview" src="<?php echo get_file_uri(get_general_file_path("company", $model_info->id) . $model_info->company_logo); ?>" alt="..." />
                        </div>
                ...
                <div class="form-group">
                    <label for="enable_company_logo" class="<?php echo $label_column; ?>"><?php echo lang('enable_client_logo'); ?>
                        <span class="help" data-container="body" data-toggle="tooltip" title="<?php echo lang('enable_client_logo_description') ?>"><i class="fa fa-question-circle"></i></span>
                    </label>
                    <div class="<?php echo $field_column; ?>">
                        <?php
                        echo form_checkbox("enable_company_logo", "1", $model_info->enable_company_logo ? true : false, "id='enable_company_logo'");
                        ?>                       
                    </div>
                </div>
                <?php } ?>
            <?php } else { ?>
                <p><?php echo lang('model_info_not_found'); ?></p>
            <?php } ?>
        </div>
