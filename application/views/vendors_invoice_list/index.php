        ...
        <ul data-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
            ...
            <div class="tab-title clearfix no-border">
                <div class="title-button-group">
                    <?php echo modal_anchor(get_uri("vendors_invoice_list/modal_form"), "<i class='fa fa-plus-circle'></i> " . lang('add_vendor_invoice'), array("class" => "btn btn-default mb0", "title" => lang('add_vendor_invoice'))); ?>
                </div>
            </div>
        </ul>
...
<script type="text/javascript">
    loadVendorsInvoiceListTable = function (selector, dateRange) {
        ...
        $(selector).appTable({
            ...
            filterDropdown: [
                {name: "status", class: "w150", options: <?php $this->load->view("vendors_invoice_list/vendors_invoice_list_dropdown"); ?>},
            ...
            columns: [
                ...
                {title: '<?php echo lang("purchase_order_no"); ?>'},
...
<?php 
// Example initialization for $members_dropdown, $status_dropdown, and $statuses
$members_dropdown = []; // Replace with your actual data
$status_dropdown = []; // Replace with your actual data
$statuses = []; // Replace with your actual data
?>
