<?php echo form_open(get_uri("service_categories/save"), array("id" => "service_category-form", "class" => "general-form", "role" => "form")); ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#service_category-form").appForm({
            onSuccess: function(result) {
                $("#service_category-table").appTable({newData: result.data, dataId: result.id});
            }
        });
        $("#title").focus();
    });
