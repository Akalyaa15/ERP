...
<?php
if (isset($estimate_info) && $estimate_info && isset($estimate_info->custom_fields) && $estimate_info->custom_fields) {
...
<?php if (isset($estimate_info) && $estimate_info && isset($estimate_info->valid_until)) : ?>
