...
<?php 
// Calculate the total tax amount, checking if each property exists first
$estimate_tax_subtotal = isset($estimate_total_summary->estimate_tax_subtotal) ? $estimate_total_summary->estimate_tax_subtotal : 0;
$installation_tax = isset($estimate_total_summary->installation_tax) ? $estimate_total_summary->installation_tax : 0;
$freight_tax3 = isset($estimate_total_summary->freight_tax3) ? $estimate_total_summary->freight_tax3 : 0;

$taxamt = $estimate_tax_subtotal + $installation_tax + $freight_tax3;

if($taxamt > 0) { ?>
<table style="width: 99%; color: #444; line-height: 15px">
    <tr style="font-weight: bold; background-color:white; color: black;">
        <th style="width: 100%; border-right: 1px solid #eee; font-weight: bold; font-size: 14px;">
            <?php
            $number = $taxamt;
            ...
            echo convertToIndianCurrencysTaxss($number);
