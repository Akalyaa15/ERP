<?php 
$list_data = null;
if(isset($buyer_type) && $buyer_type){
    $options = array(
        "id" => $buyer_type,
    );
...
if ($list_data) {
    ...
    // echo $client_buyer_type_profit;
    // echo $client_buyer_type_name;
} else {
    $client_buyer_type_profit = null;
    $client_buyer_type_name = null;
}
?>
...
<div class="modal-body clearfix">
    ...
    <input type="hidden" id="estimate_ids" name="estimate_id" value="<?php echo $estimate_id; ?>" />
     ...
     <div class="form-group">
                <label for="estimate_type" class=" col-md-3"><?php echo lang('estimate_type'); ?>  <span class="help" data-toggle="tooltip" title="<?php echo lang('estimate_type'); ?>"><i class="fa fa-question-circle"></i></span></label>
                <div class=" col-md-9">
                    <?php
                    echo form_radio(array(
                        ...
                        "data-msg-required" => lang("field_required"),
                            ), "0", ($model_info->estimate_type === "1") ? false : true);
                    ?>
                    ...
                    "1", ($model_info->estimate_type === "1") ? true : false);
                    ?>
                    <label for="service"  id="service_label" class=""><?php echo lang('service'); ?></label>
                </div>
            </div>
    <!-- estimate supply type -->
     <div id="estimate_supply_app">
    ...
    <div class="form-group">
        <label for="estimate_item_title" class=" col-md-3"><?php echo lang('model'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_input(array(
            ...
            ?>
            <a id="estimate_item_title_dropdwon_icon" tabindex="-1" href="javascript:void(0);" style="color: #B3B3B3;float: right; padding: 5px 7px; margin-top: -35px; font-size: 18px;"><span id ="close">×</span></a>
        </div>
    </div>
   ...
   <div class="form-group" id="z">
    ...
    <div class="col-md-9">
        ...
        echo form_radio(array(
            ...
            "data-msg-required" => lang("field_required"),
                ), "yes", ($model_info->with_installation === "yes") ? true : false);
        ?>
        <label for="with_installation" class="mr15"><?php echo lang('with_gst'); ?></label> 
        <?php
        echo form_radio(array(
        ...
        ?>
        <label for="without_installation"><?php echo lang('without_gst'); ?></label>
    </div>
</div>
    ...
    <div class="form-group" id="installation_new_rates" style="display:none;">
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                ...
                "value" => isset($model_info->installation_new_rate) ? $model_info->installation_new_rate : '',
                "min" => 0,
                "class" => "form-control",
                "placeholder" => lang('installation_rate')
            ));
    ...
    <div class="form-group" style="display:none" id='installation_profit'>
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                ...
                "value" => isset($model_info->installation_profit_percentage) ? $model_info->installation_profit_percentage : '',
                "min" => 0,
                "max" => 100,
                "class" => "form-control",
    ...
    <div class="form-group" id="installation_gstapp">
        ...
        <div class="col-md-9">
            ...
            echo form_radio(array(
                ...
                "data-msg-required" => lang("field_required"),
            ), "yes", ($model_info->with_installation_gst === "yes") ? true : false);
            ?>
            <label for="with_installation_gst" class="mr15"><?php echo lang('with_gst'); ?></label> 
            <?php
            echo form_radio(array(
            ...
            ?>
            <label for="without_gst"><?php echo lang('without_gst'); ?></label>
        </div>
    </div>
    <div id="ss">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                echo form_input(array(
                    ...
                    "value" => isset($model_info->installation_hsn_code) ? $model_info->installation_hsn_code : '',
                    "class" => "form-control validate-hidden",
                    "placeholder" => lang('select_or_create_new_hsn_code'),
                    "data-rule-required" => true,
                    "data-msg-required" => lang("field_required"),
    ...
    <div class="form-group" id="yy">
        ...
        <div class="col-md-9">
            ...
            echo form_input(array(
                ...
                "value" => isset($model_info->installation_gst) ? $model_info->installation_gst : '',
                "min" => 0,
                "class" => "form-control",
...
<div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "estimate_service_item_category",
                "name" => "estimate_service_item_category",
                "value" => $model_info->category,
                "class" => "form-control validate-hidden",
                "placeholder" => lang('category'),
                 "data-rule-required" => true,
  ...
  <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "estimate_service_item_title",
                "name" => "estimate_service_item_title",
                "value" => $model_info->title,
                "class" => "form-control validate-hidden",
                "placeholder" => lang('select_or_create_new_product'),
                "data-rule-required" => true,
            ...
            ?>
            <a id="estimate_service_item_title_dropdwon_icon" tabindex="-1" href="javascript:void(0);" style="color: #B3B3B3;float: right; padding: 5px 7px; margin-top: -35px; font-size: 18px;"><span id="service_close">×</span></a>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class=" col-md-9">
            <?php
            echo form_textarea(array(
                "id" => "estimate_service_item_description",
                "name" => "estimate_service_item_description",
                "value" => $model_info->description ? $model_info->description : "",
                "class" => "form-control",
                "placeholder" => lang('description'),
                "readonly"=>"true",
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            echo form_inputnumber(array(
                "id" => "estimate_service_item_quantity",
                "name" => "estimate_service_item_quantity",
                "value" => $model_info->quantity ? to_decimal_format($model_info->quantity) : "",
                "min"=>0,
                 "maxlength"=> get_setting('number_of_quantity'),
                "class" => "form-control",
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "estimate_service_unit_type",
                "name" => "estimate_service_unit_type",
                "value" => $model_info->unit_type,
                "class" => "form-control validate-hidden",
                "readonly"=>"true",
                "placeholder" => lang('unit_type') . ' (Ex: hours, pc, etc.)',
...
<div class="form-group" >
    ...
    <div class="form-group" id = 'servive_orginal_rate'>
        <label for="estimate_item_rate" class=" col-md-3"><?php echo lang('rate'); ?></label>
        <div class="col-md-9">
            <?php
            echo form_inputnumber(array(
                "id" => "estimate_service_item_rate",
                "name" => "estimate_service_item_rate",
               // "value" => $model_info->rate ? to_decimal_format($model_info->rate) : "",
    ...
    <div class="form-group" id="service_gstapp">
                <label for="estimate_recurring" class=" col-md-3"><?php echo lang('gst_applicable'); ?>  <span class="help" data-toggle="tooltip" title="<?php echo lang('gst_applicable'); ?>"><i class="fa fa-question-circle"></i></span></label>
                <div class=" col-md-9">
                    <?php
                    echo form_radio(array(
                        "id" => "service_with_gst",
   ...
   <div id="service_s">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <?php
            echo form_input(array(
                "id" => "estimate_service_item_hsn_code",
                "name" => "estimate_service_item_hsn_code",
                "value" => $model_info->hsn_code,
                "class" => "form-control validate-hidden",
                "placeholder" => lang('select_or_create_new_hsn_code'),
               "data-rule-required" => true,
     ...
     <div class="form-group"  id ="service_y">
        ...
        <div class="col-md-9">
            <?php
            echo form_inputnumber(array(
                "id" => "estimate_service_item_gst",
                "name" => "estimate_service_item_gst",
                "value" => $model_info->gst,
                "class" => "form-control",
                "min"=>0,
                "placeholder" => lang('gst'),
    ...
    <div class="form-group" id="service_z">
        ...
        <div class=" col-md-9">
            <?php
            echo form_textarea(array(
             "id" => "estimate_service_item_hsn_code_description",
            "name" => "estimate_service_item_hsn_code_description",
             "value" => $model_info->hsn_description ? $model_info->hsn_description : "",
                "class" => "form-control",
                "placeholder" => lang('hsn_description'),
                "readonly"=>"true",
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#estimate_item_make").select2({
            multiple: false,
            data: <?php echo ($make_dropdown); ?>
        });
        $("#estimate_item_category").select2({
            multiple: false,
            data: <?php echo ($product_categories_dropdown); ?>
        });

        $("#estimate_service_unit_type").select2({
                multiple: false,
                data: <?php echo json_encode($unit_type_dropdown); ?>
        });

        $("#estimate_service_item_category").select2({
            multiple: false,
...
$('#estimate_item_hsn_code').attr('readonly', true);
<?php if($model_info->title){?>
$("#estimate_item_title").attr('readonly', true);
$("#estimate_service_item_title").attr('readonly', true);
<?php } ?>
        ...
        $("#estimate_service_item_title_dropdwon_icon").click(function () {
            applySelect2OnserviceItemTitle();
        })
    ...
    function applySelect2OnItemTitle() {
        $("#estimate_item_title").select2({
            ...
            ajax: {
                ...
                data: function (term, page) {
                    return {
                        q: term,s:$("#estimate_ids").val(),category:$("#estimate_item_category").val() // search term
                    };
                },
       ...
       // $("#installation_hsn_code").val("").attr('readonly', false);
                ...
                $("#estimate_item_rate").remove().val();
                $("#estimate_item_title").select2("destroy").val("").focus().attr('readonly', false);
                $("#estimate_item_description").val("").attr('readonly', false);
        $("#estimate_unit_type").val("").attr('readonly', false);
        //$("#estimate_item_category").val("").attr('readonly', false);
        $("#estimate_item_rate").val("").attr('readonly', false);
        $("#estimate_item_make").select2("val","").attr('readonly', false);
        ...
        $("#estimate_item_category").val("").attr('readonly', false);
        $("#estimate_item_rate").show().attr('readonly', true);
        $("#estimate_item_make").val("").attr('readonly', true);
        ...
        $("#estimate_item_description").val("").attr('readonly', true);
        $("#associated_with_part_no").val("").attr('readonly', true);
                $.ajax({
                url: "<?php echo get_uri("estimates/get_estimate_item_info_suggestion"); ?>",
            data: {item_name: e.val,s:"<?php echo $estimate_id; ?>",
            client_type:"<?php echo $estimate_id; ?>"},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
...
$.ajax({
                    url: "<?php echo get_uri("estimates/get_estimate_item_info_suggestion"); ?>",
                    data: {item_name: e.val,s:"<?php echo $estimate_id; ?>",client_type:"<?php echo $estimate_id; ?>"},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
                    success: function (response) {
                        ...
                        if (response && response.success) {
                            ...
                            if (!$("#estimate_unit_type").val()) {
                                ...
                                $("#estimate_unit_type").select2('val', response.item_info.unit_type);
                            }
                         ...
                         inventory_profit =inventory_rate*response.item_info.profit_percentage/100;
                              inventory_actual_value = parseFloat(inventory_rate)+parseFloat(inventory_profit);
                                ...
                                if(a=="failed"||a == null){
                                   ...
                                   c=0; 
                                   $("#estimate_item_rate").val(c).attr('readonly', false);
                                }else if(a=="same_country"){
                                    //alert("Same Country");
                                   c=zz; 
                                   $("#estimate_item_rate").val(c).attr('readonly', true);
                                }else{
                                $("#estimate_item_rate").val(c).attr('readonly', true);
                            }
                            }
                            ...
                            $("#estimate_item_category").select2("val",response.item_info.category);
                            }
                            ...
                            /*if (!$("#estimate_item_make").val()) {
                                ...
                                $("#estimate_item_make").select2("val",response.item_info.make);
...
if (!$("#installation_gst").val()) {
                ...
                if (!$("#installation_rate").val()) {
                    ...
                    if(d=="failed"||d == null){
                                    alert("Sorry,Currency conversion cannot be done");
                                   f=0; 
                                   $("#installation_rate").val(f).attr('readonly', false);
                                }else if(d=="same_country"){
                                    //alert("same");
                                   f=e; 
                                   $("#installation_rate").val(f).attr('readonly', true);
                                }else{
                            $("#installation_rate").val(f).attr('readonly', true);
                        }
                            }
...
//ajax 3
    ...
    function applySelect2OnserviceItemTitle() {
        $("#estimate_service_item_title").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("estimates/get_estimate_service_item_suggestion"); ?>",
                dataType: 'json',
                quietMillis: 250,
                data: function (term, page) {
                    return {
                        q: term,s:$("#estimate_ids").val(),category:$("#estimate_service_item_category").val() // search term
                    };
                },
                results: function (data, page) {
                    return {results: data};
            ...
            if (e.val === "+") {
                ...
                $("#service_orginal_rate").hide();
                $("#estimate_service_item_rate").hide().val("");
               
                $("#estimate_service_item_title").select2("destroy").val("").focus().attr('readonly', false);
                $("#estimate_service_item_description").val("").attr('readonly', false);
        $("#estimate_service_unit_type").val("").attr('readonly', false);
        $("#estimate_service_unit_type").select2({
                multiple: false,
                data: <?php echo json_encode($unit_type_dropdown); ?>
            });
        //$("#estimate_service_item_category").val("").attr('readonly', false);
        $("#estimate_service_item_rate").val("").attr('readonly', false);
       
        $("#associated_with_job_id").val("");
        $("#servive_orginal_rate").remove().val();
        
        //$("#installation_hsn_code").val("").attr('readonly', false);
        $("#service_rate_id").val("");
        $("#associated_with_job_id").select2("val","").attr('readonly', false);
        $("#estimate_service_item_hsn_code").select2("destroy").val("");
        ...
        $("#add_new_service_item_to_library").val(1); //set the flag to add new service item in library
                ...
                $("#servive_orginal_rate").show();
                //$("#installation_new_rate").show();
              
                
                $("#service_rate").hide();
        $("#estimate_service_unit_type").val("").attr('readonly', true);
        $("#estimate_service_item_category").val("").attr('readonly', false);
        $("#estimate_service_item_rate").show().attr('readonly', true);
        $("#estimate_service_item_make").val("").attr('readonly', true);
        $("#installation_rate").val("").attr('readonly', true);
        $("#installation_profit_percentage").val("").attr('readonly', true);
        $("#installation_hsn_code").val("").attr('readonly', true);
        $("#estimate_service_item_description").val("").attr('readonly', true);
        $("#associated_with_job_id").val("").attr('readonly', true);
                $.ajax({
                    url: "<?php echo get_uri("estimates/get_estimate_service_item_info_suggestion"); ?>",
                    data: {item_name: e.val,s:"<?php echo $estimate_id; ?>",client_type:"<?php echo $estimate_id; ?>"},
                    cache: false,
                    type: 'POST',
                    dataType: "json",
  ...
  $.ajax({
                    url: "<?php echo get_uri("estimates/estimate_service_job_assoc_details"); ?>",
                    ...
                    success: function (response) {
                        ...
                        if (response && response.success) {
                                ...
                                $("#estimate_service_item_description").val(response.item_info.description);
                           
                            

                           
                                
                                $("#estimate_service_unit_type").select2('val', response.item_info.unit_type);
                         

                            if (!$("#estimate_service_item_category").val()) {
                                //$("#invoice_service_item_category").val(response.item_info.category);
                                 $("#estimate_service_item_category").select2("val",response.item_info.category);
                            }
                                ...
                                if(a=="failed"||a == null){
                                    alert("Sorry,Currency conversion cannot be done");
                                   c=0; 
                                    $("#estimate_service_item_rate").attr("readonly",false);
                                }else if(a=="same_country"){
                                    //alert("Same Country");
                                   c=zz; 
                                }
                                $("#estimate_service_item_rate").val(c); 
                            ...
                            $("#estimate_service_item_hsn_code").select2('destroy').val(response.item_info.hsn_code);
                                $("#estimate_service_item_hsn_code_description").val(response.item_info.hsn_description);
                            
                            
                                $("#estimate_service_item_gst").val(response.item_info.gst);
    ...
    function applySelect2OnHsnTitle() {
        $("#estimate_item_hsn_code").select2({
            ...
            if (e.val === "+") {
                ...
                $("#estimate_item_hsn_code").select2("destroy").val("").focus().attr('readonly', false);
                $("#estimate_item_gst").val("").attr('readonly', false);
                $("#estimate_item_hsn_code_description").val("").attr('readonly', false);
    ...
    // service type hsn dropdown
    function applySelect2OnserviceHsnTitle() {
        $("#estimate_service_item_hsn_code").select2({
            showSearchBox: true,
            ajax: {
                url: "<?php echo get_uri("items/get_invoice_item_suggestion"); ?>",
                dataType: 'json',
            ...
            if (e.val === "+") {
                ...
                $("#estimate_service_item_hsn_code").select2("destroy").val("").focus().attr('readonly', false);
                $("#estimate_service_item_gst").val("").attr('readonly', false);
                $("#estimate_service_item_hsn_code_description").val("").attr('readonly', false);
                ...
                $("#estimate_service_item_gst").val("").attr('readonly', true);
                $("#estimate_service_item_hsn_code_description").val("").attr('readonly', true);
                $.ajax({
                    url: "<?php echo get_uri("items/get_invoice_item_info_suggestion"); ?>",
                    data: {item_name: e.val,},
                    cache: false,
                    ...
                    success: function (response) {
                        ...
                        if (response && response.success) {
                            ...
                            if (!$("#estimate_service_item_gst").val()) {
                                $("#estimate_service_item_gst").val(response.item_info.gst);
                            }
                           if (!$("#estimate_service_item_hsn_code_description").val()) {
                                $("#estimate_service_item_hsn_code_description").val(response.item_info.hsn_description);
                            }
...
<script type="text/javascript">
    $("#estimate_item_title").on("change", function() {
   
        $("#estimate_item_gst").val("")
        $("#estimate_item_description").val("")
        //$("#estimate_unit_type").select2().val("")
        $("#estimate_unit_type").select2('val',"")
        //$("#estimate_item_category").select2("val","")
        $("#estimate_item_rate").val("")
        $("#estimate_item_make").select2("val","")
...
<script type="text/javascript">
    $("#close").on("click", function() {
        //$("#estimate_item_title").val("")
        $("#estimate_item_title").val("").attr('readonly', false)
        $("#estimate_item_gst").val("")
        $("#estimate_item_description").val("")
        $("#estimate_unit_type").select2('val',"")
        //$("#estimate_item_category").select2("val","")
...
<script type="text/javascript">
    $("#estimate_item_hsn_code").on("change", function() {
...
<script type="text/javascript">
    $("#close_hsn_code").on("click", function() {
        $("#estimate_item_hsn_code").val("").attr('readonly', false)
        $("#estimate_item_gst").val("")
...
<script type="text/javascript">
    $("#without_gst").on("click", function() {
        ...
        $("#estimate_item_hsn_code_description").hide()
        $("#estimate_item_gst").hide()
});
</script>
<script type="text/javascript">
    $("#with_gst").on("click", function() {
   
       // $("#estimate_item_hsn_code").show()
        $("#s").show()
        $("#y").show()
        $("#z").show()
       
        $("#estimate_item_hsn_code_description").show()
        $("#estimate_item_gst").show()
});
</script>
<?php 
...
$("#estimate_supply_app").hide();
$("#estimate_service_app").show();
$("#estimate_item_title").removeClass("validate-hidden")
$("#estimate_service_item_title").addClass("validate-hidden")
$("#estimate_item_category").removeClass("validate-hidden")
$("#estimate_service_item_category").addClass("validate-hidden")
...
$("#estimate_supply_app").show();
$("#estimate_service_app").hide();
$("#estimate_service_item_title").removeClass("validate-hidden")
$("#estimate_item_title").addClass("validate-hidden")
$("#estimate_item_category").addClass("validate-hidden")
$("#estimate_service_item_category").removeClass("validate-hidden")
});
...
<script type="text/javascript">
   ...
   $("#estimate_service_item_hsn_code").val("").attr('readonly', false)
        $("#estimate_service_item_gst").val("")
       
        $("#estimate_service_item_hsn_code_description").val("")
});


     $("#service_without_gst").on("click", function() {
   
       $("#estimate_service_item_hsn_code").attr('readonly', true)
        $("#service_s").hide()
        $("#service_y").hide()
        $("#service_z").hide()
       
        $("#estimate_service_item_hsn_code_description").hide()
        $("#estimate_service_item_gst").hide()
});

     $("#service_with_gst").on("click", function() {
   
       $("#estimate_service_item_hsn_code").attr('readonly', false)
        $("#service_s").show()
        $("#service_y").show()
        $("#service_z").show()
       
        $("#estimate_service_item_hsn_code_description").show()
        $("#estimate_service_item_gst").show()
});
...
<?php } ?>
<?php if($model_info->estimate_type == 1) { ?>
<script type="text/javascript">
...
<?php } ?>
<?php if($model_info->id && $model_info->estimate_type == 0) { ?>
<script type="text/javascript">
...
<script type="text/javascript">
   $("#estimate_item_category").change(function () {
    //$("#invoice_item_title").val("").select2('readonly', false)
   $("#close").click();
   }); 

   $("#estimate_service_item_category").change(function () {
    //$("#invoice_item_title").val("").select2('readonly', false)
   $("#service_close").click();
   });  
...
<script type="text/javascript">
    $("#service_close").on("click", function() {
        $("#estimate_service_item_title").val("").attr('readonly', false)
        $("#estimate_service_item_gst").val("")
        $("#estimate_service_item_description").val("")
        //$("#invoice_unit_type").val("")
        $("#estimate_service_unit_type").select2('val',"")
        //$("#invoice_item_category").val("")
        $("#estimate_service_item_rate").val("")
       
        $("#estimate_service_item_hsn_code").select2("destroy").val("")
        $("#estimate_with_job_id").val("")
        $("#estimate_service_item_hsn_code_description").val("")
        $("#service_rate_id").val("")
});
</script>
