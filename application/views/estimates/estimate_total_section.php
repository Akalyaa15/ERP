<table id="estimate-item-table" class="table display dataTable text-right strong table-responsive" style="width: 100px;">
    ...
    <?php if (isset($invoice_total_summary)) : ?>
        <tr>
...
<?php } ?>
   ...
   <tr>
    ...
    <td><?php echo to_currency($estimate_total_summary->estimate_total, $estimate_total_summary->currency_symbol); ?></td>
     ...
     <?php if ($estimate_total_summary->total_paid) { ?>
        <tr>
            ...
            <td><?php echo to_currency($estimate_total_summary->total_paid, $estimate_total_summary->currency_symbol); ?></td>
            <td></td>
        </tr>
    <?php } ?>
    ...
    <td><?php echo to_currency($estimate_total_summary->balance_due, $estimate_total_summary->currency_symbol); ?></td>
        <td></td>
    </tr>
</table>