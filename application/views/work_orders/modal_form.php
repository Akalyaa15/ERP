...
<div class="form-group">
    ...
    <div class="col-md-9">
        <?php
        echo form_dropdown("outsource_user_id", $members_dropdown, isset($model_info->user_id) ? $model_info->user_id : '', "class='select2 validate-hidden' id='outsource_user_id'");
        ?>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class=" col-md-9">
        ...
        echo form_input(array(
            "id" => "work_order_no",
            "name" => "work_order_no",
            "value" => isset($model_info->work_order_no) ? $model_info->work_order_no : '',
            "class" => "form-control",
