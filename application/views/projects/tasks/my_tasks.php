<?php
// Initialize $status_id with a default value if it's not already set
...
<div id="page-content" class="p20 clearfix">
    ...
    <div class="panel panel-default">
        <div class="table-responsive">
            <table id="task-table" class="display" cellspacing="0" width="100%"></table>
        </div>
    </div>
</div>
...
foreach ($task_statuses as $status) {
    $is_selected = false;
    if ($status_id && $status->id == $status_id) {
        $is_selected = true;
    } elseif (!$status_id && $status->key_name != "done") {
        $is_selected = true;
    }
