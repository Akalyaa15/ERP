...
<script type="text/javascript">
    $(document).ready(function () {
        var optionVisibility = <?php echo ($can_edit_projects || $can_delete_projects) ? 'true' : 'false'; ?>;
        ...
        $("#project-table").appTable({
            ...
            multiSelect: [
                ...
                <?php if (isset($widget_status) && $widget_status == "completed") { ?>,
                {
                    name: "status",
                    text: "<?php echo lang('status'); ?>",
                    options: [
            ...
            filterDropdown: [
                ...
                {name: "project_manager", class: "w200", options: <?php echo $active_team_members_dropdown; ?>}
                <?php } ?>
            ],
            singleDatepicker: [
            ...
            columns: [
                ...
                {title: '<?php echo lang("start_date") ?>', "class": "w10p", "iDataSort": 5},
                {visible: false, searchable: false},
                {title: '<?php echo lang("deadline") ?>', "class": "w10p", "iDataSort": 7},
