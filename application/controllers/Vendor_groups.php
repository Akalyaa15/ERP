...
class Vendor_groups extends MY_Controller {
    ...
    function index() {
        $this->template->rander("vendor_groups/index");
    }
    ...
    function modal_form() {
        ...
        $view_data['model_info'] = $this->Vendor_groups_model->get_one($this->input->post('id'));
        $this->load->view('vendor_groups/modal_form', $view_data);
    }
    ...
    function save() {
        ...
        $save_id = $this->Vendor_groups_model->save($data, $id);
        if ($save_id) {
    ...
    function list_data() {
        $list_data = $this->Vendor_groups_model->get_details()->result();
        $result = array();
    ...
    private function _row_data($id) {
        $options = array("id" => $id);
        $data = $this->Vendor_groups_model->get_details($options)->row();
