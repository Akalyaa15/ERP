...
class Payment_methods extends MY_Controller {
    ...
    function save() {
        ...
        $data = array(
            ...
            "available_on_purchase_order" => unformat_currency($this->input->post('available_on_purchase_order')),
            "available_on_work_order" => unformat_currency($this->input->post('available_on_work_order')),
    ...
    private function _make_row($data) {
        ...
        if (!$data->online_payable) {
            $options.=js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_payment_method'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("payment_methods/delete"), "data-action" => "delete-confirmation"));
        }
