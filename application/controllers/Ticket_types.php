...
class Ticket_types extends MY_Controller {
    ...
    private function _make_row($data) {
        return array($data->title,
            ...
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_ticket_type'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("ticket_types/delete"), "data-action" => "delete-confirmation"))
        );
    }
