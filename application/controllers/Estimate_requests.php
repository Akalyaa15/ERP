...
class Estimate_requests extends MY_Controller {
    ...
    private function _make_form_row($data) {
        ...
        return array(
            ...
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_estimate_form'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("estimate_requests/delete_estimate_request_form"), "data-action" => "delete-confirmation"))
        );
    }
    ...
    private function _make_form_field_row($data) {
        ...
        return array(
            ...
            . js_anchor("<i class='fa fa-times fa-fw'></i>", array('title' => lang('delete_estimate_form'), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("estimate_requests/estimate_form_field_delete"), "data-action" => "delete-confirmation"))
        );
    }
