...
function get_employee_details() {
        ...
        $item = (1+$this->Users_model->get_item_info_suggestion($this->input->post("branch"),$this->input->post("designation"),$this->input->post("country"),$this->input->post("department")));
        if ($item) {
...
if(!$this->login_user->is_admin){
    ...
    function job_info($user_id) {
        ...
        // branch dropdown
        $company_branch = $this->Branches_model->get_all_where(array("deleted" => 0,"company_setup_country"=>$view_data['user_info']->country))->result();
