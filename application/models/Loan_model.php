...
class Loan_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $where = " WHERE $loan_table.deleted = 0 "; // Initialize WHERE clause
        ...
        $sql = "SELECT $loan_table.*, 
                       ...
                       $vendors_table.company_name AS vendor_company,
                ...
                LEFT JOIN (SELECT loan_id, SUM(title) AS paid_amount FROM $loan_payment_list_table WHERE deleted = 0 GROUP BY loan_id) AS payments_table ON payments_table.loan_id = $loan_table.id
