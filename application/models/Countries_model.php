...
function get_details($options = array()) {
    ...
    return $this->db->query($sql, $params); // Pass params array to query
}
...
function get_country_id_excel($options = array()) {
    ...
    if ($country) {
        ...
        $params[] = $country; // Add country to params array
    }
