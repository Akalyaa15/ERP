...
class Clients_po_payments_list_model extends Crud_model {

    private $table = null;

    function __construct() {
        $this->table = 'clients_po_payments_list';
        parent::__construct($this->table);
    }

    function get_details($options = array()) {
        $checklist_items_table = $this->db->dbprefix("clients_po_payments_list");
    ...
    function get_yearly_payments_chart($year) {
        $payments_table = $this->db->dbprefix('clients_po_payments_list');
        $purchase_orders_table = $this->db->dbprefix('clients_po_list');
