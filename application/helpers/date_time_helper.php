...
if (!function_exists('attendance_format_to_date')) {

    function attendance_format_to_date($date_time) {
        if (!$date_time) {
            return "";
        }
...
// attendance date time format
if (!function_exists('attendance_format_to_time')) {

    function attendance_format_to_time($date_time) {
...
//attendance datetime format
if (!function_exists('attendance_format_to_datetime')) {

    function attendance_format_to_datetime($date_time) {
        /*if ($convert_to_local) {
            $date_time = convert_date_utc_to_local($date_time);
        }*/
        $target_date = new DateTime($date_time);
