...
class TCPDF {
	...
	public function setPrintFooters($val=true) {
		$this->print_footers = $val ? true : false;
	}

	public function setPrintPayslip_Footers($val=true) {
		$this->print_Payslip_footers = $val ? true : false;
	}

	public function setVoucherFooter($val=true) {
		$this->print_voucher_footer = $val ? true : false;
	}
...
//border
       ...
       $this->SetLineStyle( array( 'width' => 0.40, 'color' =>array(75, 170, 227)));
       ...
       $this->SetFont('Helvetica',"",90);
$this->SetTextColor(43, 177, 208);
$this->SetAlpha(0.15);

$this->RotatedText(35,210,'GEMICATES',50);
...
public function Footers() {
    // Position at 15 mm from bottom
        ...
        $this->SetFont('helvetica', 'I', 8);
        //text
        $this->Cell(0, 0, 'This is a Computer Generated Invoice', 0, 0, 'C');
        // Page number
        $this->Cell(0, 10, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
$this->RotatedText(35,210,'GEMICATES',50);
	...
	//payslip footer
	public function Payslip_Footers() {
    // Position at 15 mm from bottom
        $this->SetY(-15);
        // Set font
        $this->SetFont('helvetica', 'I', 8);
        //text
        $this->Cell(0, 0, 'This is a Computer Generated Payslip', 0, 0, 'C');
        // Page number
        $this->Cell(0, 10, 'Page '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'C', 0, '', 0, false, 'T', 'M');
...
$this->RotatedText(35,210,'GEMICATES',50);
	...
	//voucher footer
	public function Voucher_footer() {
